...
, {
  ...
  , link = "https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/parseInt$compare?locale=ja&to=1279273&from=1105781"
...
, {
    text = "P0053 - C++ Synchronized Buffered Ostream: fixed to return *this in __basic_syncbuf::operator= and changed the variable name so that the declaration of 'syncbuf' does not shadow a global declaration(line: 324)."
  , link = "https://github.com/PeterSommerlad/SC22WG21_Papers/pull/5"
  , genre = g.genreToText (g.Genre.Cpp {=})
  , date = { yyyy = 2017, mm = 11, dd = 23 }
  }
, {
    text = "meta-cpp/clang: Fix to enable compilation with clang and gcc other than Visual C++."
